...
import (
	...
	filepostprocessing "github.com/opencloud-eu/opencloud/services/filepostprocessing/pkg/command"
...
func NewService(ctx context.Context, options ...Option) (*Service, error) {
	...
	reg(3, opts.Config.Filepostprocessing.Service.Name, func(ctx context.Context, cfg *occfg.Config) error {
		cfg.Filepostprocessing.Context = ctx
		cfg.Filepostprocessing.Commons = cfg.Commons
		return filepostprocessing.Execute(cfg.Filepostprocessing)
	})
